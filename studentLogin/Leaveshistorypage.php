...
$details=mysqli_query($conn,"SELECT COUNT(`rollnum`) AS coun FROM `tbl_leave` WHERE `status`= 'Pending' AND `rollnum`='$rollnum'");
$array=mysqli_fetch_array($details);

$details3=mysqli_query($conn,"SELECT COUNT(`rollnum`) AS coun FROM `tbl_leave` WHERE `status`= 'Accepted' AND `rollnum`='$rollnum'");
$array3=mysqli_fetch_array($details3);

$details4=mysqli_query($conn,"SELECT COUNT(`rollnum`) AS coun FROM `tbl_leave` WHERE `status`= 'Rejected' AND `rollnum`='$rollnum'");
